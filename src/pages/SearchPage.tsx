...
export default function SearchPage(props:{items:Item[]}) {
    ...
    return (
        <div className="flex-1 flex flex-col items-center gap-3 m-auto p-2">
            <h1 className='text-4xl font-extrabold tracking-tight bg-gradient-to-r from-pink-300 to-rose-300 bg-clip-text text-transparent drop-shadow-md text-center'>搜索：{text}</h1>
